...
@IonicPage()
@Component({
  selector: 'page-modal-instalaciones-dth-entel',
  templateUrl: 'modal-instalaciones-dth-entel.html',
})
export class ModalInstalacionesDthEntelPage {
  ...
  enviarFormulario() {
    ...
    if (this.images.length > 0) {
      ...
      for (let i = 0; i < this.images.length; i++) {
        this.savePicture(this.images[i], this.instalacionesDth.value.ot_servicorp + '_entel_' + date.getDay() + '-' + date.getMonth() + '-' + date.getFullYear() + (i+1))
      }
