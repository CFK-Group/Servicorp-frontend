...
export class PreguntasProvider {
  ...
  getPreguntasFibraEntel(): Observable<Pregunta[]> {
    return of([
      ...
      { obligatoria: true, necesitaFoto: false, formControlName: 'resp_25', estado: 'activo', id: 709, glosa: '¿Cliente pide extensor via WIFI?', orden: 27, tipo: 'si/no/no aplica' },
      { obligatoria: true, necesitaFoto: false, formControlName: 'resp_26', estado: 'activo', id: 710, glosa: '¿Cliente pide decodificador via WIFI?', orden: 28, tipo: 'si/no/no aplica' },
      ...
      { obligatoria: true, necesitaFoto: false, formControlName: 'resp_37', estado: 'activo', id: 721, glosa: '¿Plan full con decos cableados?', orden: 39, tipo: 'si/no/no aplica' },
      ...
      { obligatoria: true, necesitaFoto: false, formControlName: 'resp_48', estado: 'activo', id: 732, glosa: '¿Access Point es el modelo nuevo? ', orden: 50, tipo: 'si/no/no aplica' },
      { obligatoria: true, necesitaFoto: false, formControlName: 'resp_49', estado: 'activo', id: 733, glosa: '¿ONT es el modelo nuevo?', orden: 51, tipo: 'si/no/no aplica' },
